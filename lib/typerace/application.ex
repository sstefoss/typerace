defmodule Typerace.Application do
  ...
  def start(_type, _args) do
    ...
    opts = [strategy: :one_for_one, name: Typerace.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    TyperaceWeb.Endpoint.config_change(changed, removed)
    :ok
  end
end
