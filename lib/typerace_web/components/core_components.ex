defmodule TyperaceWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(TyperaceWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(TyperaceWeb.Gettext, "errors", msg, opts)
    end
  end
